...
from task01_exceptions import ParceDaysExceptions, WrongFormatDate,\
    WeekNumberError, WeekDayNameError, \
    MonthNameError
from task01_log import Log
...
class TextToDate:
    ...
    def _calc_date(self) -> None | ParceDaysExceptions:
        ...
        while date_start.weekday() != day_no:
            date_start += timedelta(days=1)

        self._date_value = date_start + timedelta(days=7 * (week_no - 1))
        return
